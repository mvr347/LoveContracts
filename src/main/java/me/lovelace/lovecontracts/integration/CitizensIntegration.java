 ...
 * LoveTweaks'/LoveHunt's CitizensIntegration so the plugin loads fine whether or not Citizens is present.
 */
public final class CitizensIntegration {
    ...
    /**
     * Resolves the NPC the player is currently looking at, used for admin NPC binding
     * instead of Citizens' own selector API.
     */
