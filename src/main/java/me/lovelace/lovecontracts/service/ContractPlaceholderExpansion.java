    ...
    public @Nullable String onRequest(OfflinePlayer player, @NotNull String params) {
        ...
        try {
            return switch (params.toLowerCase()) {
                ...
                case "total_completed" -> String.valueOf(getStat(uuid, "total_completed"));
                ...
                case "active_contracts" -> String.valueOf(plugin.getContractManager().getActiveContracts().size());
                default -> null;
            };
        } catch (Exception e) {
